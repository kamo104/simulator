...
int main(int argc, char *argv[]) {
  ...
  FlightPlan plan;
  /*plan.route.push_back(FlightSegment{ geo2xy(GeoPos<double>{{52.7, 17, 10000.0}}),
  ...
  FlightPlan plan2;
  plan2.route.push_back(FlightSegment{ geo2xy(GeoPos<double>{{52.5, 16, 10000.0}}),
  ...
  simState->planes.push_back(
      Plane(data::PlaneData{ {1, 1, false, "LOT", "287",
          ...
          Velocity{100, hdg2rad(0)}, {{52.4, 16, 1000}} },
          plan2, &config));
